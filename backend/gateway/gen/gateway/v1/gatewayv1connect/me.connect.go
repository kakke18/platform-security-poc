...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/kakke18/platform-security-poc/backend/gateway/gen/gateway/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	MeServiceName = "gateway.v1.MeService"
)
...
func NewMeServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MeServiceClient {
	...
	meServiceMethods := v1.File_gateway_v1_me_proto.Services().ByName("MeService").Methods()
